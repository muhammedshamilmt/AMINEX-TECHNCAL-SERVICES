...
const services = [

  {
    ...
    icon: Network,
    image: "https://cdn.gs-it.ae/images/ict-solutions/main.jpg",
  ...
  // },
  {
    ...
    icon: Cpu,
    image: "https://www.controlautomationsolutions.com/wp-content/uploads/2023/01/Industrial-Automation-01-1024x733.png",
                  ...
                  <div className="flex -space-x-2">
                    {[1, 2, 3].map((i) => (
                      <div key={i} className="w-10 h-10 rounded-full border-2 border-zinc-900 overflow-hidden bg-zinc-800">
                        <Image
                          src={`https://images.unsplash.com/photo-1535713875002-d1d0cf377fde?w=900&auto=format&fit=crop&q=60&ixlib=rb-4.1.0&ixid=M3wxMjA3fDB8MHxzZWFyY2h8OHx8cHJvZmlsZXxlbnwwfHwwfHx8MA%3D%3D${i + 30}`}
                          alt="Team"
                          width={40}
                          height={40}
                        />
