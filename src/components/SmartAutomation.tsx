...
Smart Automation
  ...
  >
  Let's <span className="text-orange-500 italic" style={{ fontFamily: "'Instrument Serif', serif" }}>Optimize</span> Your <br />
  Workflow
  </motion.h2>
...
>
Deploy intelligent automation, monitor system performance in real-time, and stay ahead with Aminex's integrated technical tools designed for peak efficiency and reliability.
</motion.p>
...
{/* Floating Card: System Performance */}
<motion.div
initial={{ opacity: 0, x: -20, y: 20 }}
whileInView={{ opacity: 1, x: 0, y: 0 }}
viewport={{ once: true }}
transition={{ duration: 0.8, delay: 0.4 }}
className="absolute md:absolute top-[80%] md:top-1/2 -right-4 md:-right-16 bg-white rounded-2xl p-4 md:p-6 shadow-2xl border border-zinc-100 w-64 md:w-80 z-10"
>

              <div className="space-y-4">
                <div className="flex items-center justify-between">
                   <p className="text-[10px] text-zinc-400 font-bold uppercase tracking-wider">System Performance</p>
                </div>
                <div className="space-y-1">
                  <p className="text-sm font-bold text-zinc-900 leading-tight">Automation Efficiency Index</p>
                </div>
                <div className="flex items-end gap-5">
                  ...
                  <div className="shrink-0 text-right pb-1">
                    <p className="text-2xl font-bold text-zinc-900 leading-none">A+</p>
                    <div className="flex flex-col items-end gap-1 mt-2">
                      ...
                      <span className="text-zinc-400 text-[8px] font-medium leading-tight">Optimized vs <br />manual control</span>
                    </div>
                  </div>
                </div>
              </div>
